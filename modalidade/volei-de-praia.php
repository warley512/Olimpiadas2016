<?php
$cabecalho_title = "$Volei-de-praia<";
...
<P> - Variação natural do vôlei, a modalidade praticada na areia foi inventada em 1895,
	...
	circuito, composto por etapas jogadas em cinco praias da Califórnia. </P>

	<p>O sucesso da iniciativa motivou a fundação, em 1960, da California Beach Volleyball
		...
		nos Jogos de Atlanta, a modalidade tornou-se oficialmente um esporte olímpico.</p>

		<P>No Brasil, a modalidade passou a ser praticada na década de 1930, de forma amadora,
			...
			como mera brincadeira de fim de semana.</P>

			<p>Isso mudou a partir de 1986, quando se realizou o Hollywood Volley,
